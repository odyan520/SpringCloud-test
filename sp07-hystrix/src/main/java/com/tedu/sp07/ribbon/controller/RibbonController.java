package com.tedu.sp07.ribbon.controller;
...
@RestController
public class RibbonController {//负载均衡,重试
	@Autowired
	...
	public JsonResult<List<Item>> getItems(@PathVariable String orderId){
		return rt.getForObject("http://item-service/{orderId}", JsonResult.class, orderId);
	}
	...
	public JsonResult<List<Item>> getItemsFB(String orderId){
		return JsonResult.err("获取订单列表失败");
	}
